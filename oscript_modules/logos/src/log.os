...
Процедура ДополнительныеПоля(Знач пДополнительныеПоля, Знач Заместить = Истина) Экспорт
	Если Заместить Тогда
		мДополнительныеПоляЛога = пДополнительныеПоля;
	Иначе
		Для каждого КлючЗначение Из пДополнительныеПоля Цикл
			мДополнительныеПоляЛога.Вставить(КлючЗначение.Ключ, КлючЗначение.Значение);
		КонецЦикла;	
	КонецЕсли;
