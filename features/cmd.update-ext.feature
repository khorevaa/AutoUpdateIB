...
Примеры:
    ...
    | Расширение адаптация | tests/fixtures/one-base-extentions.yaml | Адаптация | tests/fixtures/cfe/Адаптация.cfe | Ложь | 1Проверка возможности применения расширения <Адаптация> - пройдена |
