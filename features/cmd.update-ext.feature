...
Структура сценария: <Сценарий>
    ...
    И Я указываю параметры расширения для расширения <ИмяРасширения>, <ПутьКРасширению>, <БезопастныйРежим>
...
Примеры:
    | Сценарий | ПутьКФайлу | ИмяРасширения | ПутьКРасширению | БезопастныйРежим | РезультатПроверки |
    | Обновление расширений одной базы | tests/fixtures/one-base-extentions.yaml | Адаптация | tests/fixtures/cfe/Адаптация.cfe | Истина | Работа1 по обновлению завершена |
