...
Контекст: Контекст файловой базы для обновления
    ...
    И Я устанавливаю настройки ОчередьОбновленияRMQ сервер "localhost" порт "8080" пользователь "guest" пароль "guest" виртуальный хост "%2f" очередь "all.update" 
...
Сценарий: Обновление конфигурации в режиме агента
    ...
    И Я добавляю параметр "--rmq-port 8080" для команды "AutoUpdateIB"
