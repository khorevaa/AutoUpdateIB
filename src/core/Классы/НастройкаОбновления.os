...
Процедура УстановитьПутьКФайлуОбнолвения(Знач ПутьКФайлу, Знач НомерРелиза = "") Экспорт

	НастройкаПолученияФайлаОбновления = Новый Структура("Файл");
	НастройкаПолученияФайлаОбновления.Файл = Новый Структура("ПутьКФайлу, НомерРелиза", ПутьКФайлу, НомерРелиза);

	ФайлОбновления = Новый ПолучениеФайлов(КаталогКешаФайлов, НастройкаПолученияФайлаОбновления);
