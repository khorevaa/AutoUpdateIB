...
Перем НастройкаКластера1С Экспорт;
...
Процедура ПриСозданииОбъекта(Знач Наименование)
	...
	АвторизацияВИнфомарционнойБазе = Новый Структура("Пользователь, Пароль", "Администратор", "");
	...
	НастройкаКластера = Новый Структура("Пользователь, Пароль, Порт", "Администратор", "", 1545);
