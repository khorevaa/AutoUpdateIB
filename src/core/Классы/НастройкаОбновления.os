...
Функция НадоОбновитьКонфигурацию() Экспорт
	Возврат Истина; // TODO: Подумать как сделать проверку необходимости обновления 
	
		// ПараметрыОбновленияКонфигурации.Свойство("ПутьКФайлуОбновления")
		// И ЗначениеЗаполнено(ПараметрыОбновленияКонфигурации.ПутьКФайлуОбновления);
КонецФункции
