...
Функция Параметры(ВходящиеПараметры) Экспорт
	...
	ИначеЕсли ВходящиеПараметры.Свойство("ВстроенныеФайлы") Тогда

		НастроитьПолучениеВстроенныхФайлов(ВходящиеПараметры.ВстроенныеФайлы);
...
Процедура ОписаниеПараметров(Знач КонструкторПараметров) Экспорт
	...
	КонструкторПараметров		
		...
		.ПолеОбъект("ВстроенныеФайлы internal", Новый ПолучениеВстроенныхФайлов, Ложь)
