...
Функция ПолучитьПутьКФайлу(Знач ИмяФайла) Экспорт
	...
	МенеджерЗапакованныхФайлов = Новый МенеджерЗапакованныхФайловAutoUpdateIB;
...
Функция ПолучитьВременныйПутьКФайлу(Знач ИмяФайла) Экспорт
	...
	ПутьКФайлу = ВременныеФайлы.Имя(ФайлРаспаковки.Расширение);
...
Функция ПолучитьПутьКВременномуФайлу(Знач ИмяФайла)
	ПутьКФайлу = ОбъединитьПути(КаталогВременныхФайлов(), ".AutoUpdateIB", ИмяФайла);
	Возврат ПутьКФайлу;
КонецФункции
