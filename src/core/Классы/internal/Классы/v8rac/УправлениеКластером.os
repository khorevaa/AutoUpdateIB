...
Процедура СнятьБлокировкуИнформационнойБазы(Знач ИнформационнаяБаза, 
	...
	ПараметрыИнформационнойБазы.Вставить("--denied-message", "");
	ПараметрыИнформационнойБазы.Вставить("--permission-code", "");
	ПараметрыИнформационнойБазы.Вставить("--denied-from", "");
	ПараметрыИнформационнойБазы.Вставить("--denied-to", "");
	
	ОбновитьПараметрыИнформационнойБазы(ИнформационнаяБаза, ПараметрыИнформационнойБазы);	

КонецПроцедуры

Процедура СоздатьИнформационнуюБазу(Знач Наименование, 
									Знач ТипСУБД,
	...
	Если ЗначениеЗаполнено(Описание) Тогда
		Параметры.Добавить("--descr=" + Описание);
	КонецЕсли;
...
Процедура УдалитьИнформационнуюБазы(Знач ИнформационнаяБаза,
