...
Процедура СоздатьРезервнуюКопию() Экспорт
	...
	Лог.Поля("ВремяВыполнения", Таймер.ВремяЗамера()).Информация("Резервная копия информационной базы создана");
...
Процедура ВосстановитьРезервнуюКопию() Экспорт
	...
	Лог.Поля("ВремяВыполнения", Таймер.ВремяЗамера()).Информация("Информационная база восстановлена из резервной копии");
