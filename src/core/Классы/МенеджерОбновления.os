...
Процедура ПередОбновлением()
	...
	Исключение
		ОписаниеОшибкиОбновления = СтрШаблон("Выполнение перед обновлением информационной базы: %1", ОписаниеОшибки());
...
Процедура ПослеОбновления()
	...
	Исключение
		...
		ЗафиксироватьОшибкуОбновления(СтрШаблон("Выполнение после обновления информационной базы: %1", ОписаниеОшибки()));
