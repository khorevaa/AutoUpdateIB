...
Процедура ОписаниеКоманды(Команда) Экспорт
	...
	Команда.Опция("F use-full-ditr", Ложь, "использовать для обновления полный дистрибутив")
				.ВОкружении("DB_PASSWORD IB_PWD");
...
Процедура ВыполнитьКоманду(Знач Команда) Экспорт
	...
	ИспользоватьПолныйДистрибутив = Команда.ЗначениеОпции("use-full-ditr");
	...
	НастройкаОбновления.УстановитьПутьКФайлуОбнолвения(ПутьКОбновлению); // Строка, путь к файлу или каталогу содержащему обновление
	НастройкаОбновления.ИспользоватьПолныйДистрибутив = ИспользоватьПолныйДистрибутив;
