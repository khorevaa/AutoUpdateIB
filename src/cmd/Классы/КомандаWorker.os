...
Процедура ОписаниеКоманды(Команда) Экспорт
	...
	Команда.Опция("agent-id", "", "идентификатор агента").ТСтрока();
...
Процедура ВыполнитьКоманду(Знач Команда) Экспорт
	...
	ИдентификаторАгента = Команда.ЗначениеОпции("agent-id");
	
	Агент = Новый РабочийПроцессАгента(ИдентификаторРабочегоПроцесса, ИдентификаторАгента);
